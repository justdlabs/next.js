...
const intents = {
  ...
  secondary: {
    base: [badgeIntents.secondary, '[&_[slot=remove]:hover]:bg-fg [&_[slot=remove]:hover]:text-background'],
    selected: [
  ...
  info: {
    base: [badgeIntents.info, '[&_[slot=remove]:hover]:bg-info [&_[slot=remove]:hover]:text-background'],
    selected: [
  ...
  light: {
    base: [badgeIntents.light, '[&_[slot=remove]:hover]:bg-black [&_[slot=remove]:hover]:text-white'],
    selected: ['bg-white ring-white text-zinc-900 ring-inset ring-fg']
  },
  dark: {
    base: [badgeIntents.dark, '[&_[slot=remove]:hover]:bg-fg [&_[slot=remove]:hover]:text-background'],
    selected: [
  ...
  'light/dark': {
    base: [badgeIntents['light/dark'], '[&_[slot=remove]:hover]:bg-fg [&_[slot=remove]:hover]:text-background'],
    selected: [
...
const TagGroup = ({ children, ...props }: TagGroupProps) => {
  return (
    <TagGroupPrimitive {...props} className={twMerge('flex flex-wrap flex-col gap-1', props.className)}>
